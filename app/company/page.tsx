        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Active Job Cards</h2>
                <p className="text-sm text-gray-600 mt-1">Monitor your ongoing jobs</p>
              </div>
            ...
            <div className="p-6">
              <div className="space-y-3">
                {[
                  { id: 1, title: 'Office Repairs', provider: 'John Doe', status: 'in_progress', priority: 'high' },
                  { id: 2, title: 'Maintenance Check', provider: 'Jane Smith', status: 'accepted', priority: 'medium' },
                  { id: 3, title: 'Installation Work', provider: 'Mike Johnson', status: 'pending', priority: 'low' },
                ].map((job) => (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="p-6 space-y-3">
                ...
                <button className="w-full px-4 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium flex items-center justify-center gap-2">
                  <UserCheck className="w-4 h-4" />
                  Add Provider
                </button>
                <button className="w-full px-4 py-3 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium">
                  View Reports
                </button>
              </div>
            </div>
